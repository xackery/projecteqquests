...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 55557 => 1,55561 => 1)) { # Item: Note to Gilipus, Item: Worker's Badge - number 2
    ...
    quest::exp(70000);	
    quest::summonitem(55562); # Item: Worker's Badge - Number three
  }
    ...
    quest::exp(80000);  
    quest::summonitem(55563); # Item: Worker's Badge - number four
  }
    ...
    quest::exp(90000); 
    quest::summonitem(55564); # Item: Worker's Badge - number five
    quest::summonitem(55556); # Item: Vial of Anti-Rusting Agent
  }
